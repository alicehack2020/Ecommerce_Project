...
const Registration = () => {
  ...
  return (
    <>
      <div className="bg-gray-300 w-full  h-auto px-5 py-4 flex">
        {/* Left Side */}
        <div className="bg-blue-500 w-auto px-8 py-8">
        ...
        <div className="bg-white px-10 py-10">
          <div className="pb-5">
            <input
              ...
              className="border border-2 w-100 h-10 px-5"
            />
          </div>
          ...
          <div className="flex gap-2 pb-5">
            ...
            <p>{inputValue.isTermSelected ? "Checked" : "Unchecked"}</p>
          </div>
          ...
          <div className="my-40 text-center">
            <button
              onClick={submitData}
              className="bg-blue-300 px-5 py-2 rounded-3xl text-white font-bold"
            >
              Create An Account
            </button>
          </div>
