...
const Login = () => {
  ...
  return (
    <>
      <div className=" md:w-full flex md:h-auto md:px-5 md:py-4">
        <div className="md:flex md:m-auto md:w-max">
          {/* Left Side */}
          <div className="bg-blue-500 w-full md:w-auto md:px-8 md:py-8 hidden md:block">
          ...
          <div className="bg-white px-10 py-10">
            <div className="pb-5">
              <input
                ...
                className="border w-full md:w-full h-10 px-5"
              />
            </div>
            ...
            <div className="text-center bg-orange-400 text-white py-2 cursor-pointer">
              <button onClick={loginHandler} className="cursor-pointer">
                Login
              </button>
            </div>

            <div className="my-40 text-center text-blue-500 font-bold">
